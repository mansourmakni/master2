			  ...
			  <%
				...
				<div class="caption">
				  <h5><%=upload.getTitle()%></h5>
				   ...
				   <h4 style="text-align:center"><a class="btn" href="product_details.jsp"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">&euro;upload.getprix()</a></h4>
				<h6><%=upload.getprix()%></h6>
				</div>
				<%
