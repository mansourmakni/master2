<div id="sidebar" class="span3">
		...
		<ul id="sideManu" class="nav nav-tabs nav-stacked">
			<li class="subMenu open"><a> Electro</a>
				<ul>
				<li><a class="active" href="products.jsp?type=Réfrigérateur"><i class="icon-chevron-right"></i>Réfrigérateur</a></li>
				<li><a href="products.jsp?type=Lavage"><i class="icon-chevron-right"></i>Lavage</a></li>
				<li><a href="products.jsp?type=Cuisson"><i class="icon-chevron-right"></i>Cuisson</a></li>
				<li><a href="products.jsp?type=Chaud/Froid"><i class="icon-chevron-right"></i>Chaud/Froid</a></li>
				<li><a href="products.jsp?type=Petit déjeuner"><i class="icon-chevron-right"></i>Petit déjeuner</a></li>
				<li><a href="products.jsp?type=Bien être"><i class="icon-chevron-right"></i>Bien être</a></li>
				<li><a href="products.jsp?type=Soins maison"><i class="icon-chevron-right"></i>Soins maison</a></li>
				<li><a href="products.jsp?type=Jardinage"><i class="icon-chevron-right"></i>Jardinage</a></li>
